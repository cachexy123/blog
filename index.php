        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-8">
                    ...
                    $result = $conn->query("select a.id,a.title,a.n,a.author,b.class_name,a.c_time,a.keyword,a.content from article as a,cate as b where a.cateid = b.id order by a.id desc limit $start,$subPages");
