        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-8">
                    ...
                    $result = $conn->query("select a.id,a.title,a.n,a.author,b.class_name,a.c_time,a.keyword,a.content from article as a,cate as b where a.cateid = b.id and b.id = $id order by a.id desc limit $start,$subPages");
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <?php
                            $result_count1=$conn->query("select a.id,a.title,a.n,a.author,b.class_name,a.c_time,a.keyword,a.content from article as a,cate as b where a.cateid = b.id and b.id = $id order by a.id desc");
